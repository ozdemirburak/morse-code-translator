;(function (name, root, factory) {
  ...
  var characters = {
    ...
    '12' : { // Thai Alphabet => https://th.wikipedia.org/wiki/รหัสมอร์ส
      // characters
      'ก': '110', 'ข': '1010', 'ฃ': '1010', 'ค': '101', 'ฅ': '101', 'ฆ': '101', 'ง': '10110', 
      'จ': '10010', 'ฉ': '1111', 'ช': '1001', 'ซ': '1100', 'ญ': '0111', 'ด': '100', 'ฎ': '100',
      'ต': '1', 'ฏ': '1', 'ถ': '10100', 'ฐ': '10100', 'ท': '10011', 'ธ': '10011', 'ฑ': '10011',
      'ฒ': '10011', 'น': '10', 'ณ': '10', 'บ': '1000', 'ป': '0110', 'ผ':'1101', 'ฝ': '10101',
      'พ': '01100', 'ภ': '01100', 'ฟ': '0010', 'ม': '11', 'ย': '1011', 'ร': '010', 'ล': '0100',
      'ฬ': '0100', 'ว': '011', 'ศ': '000', 'ษ': '000', 'ส': '000', 'ห': '0000', 'อ': '10001', 
      'ฮ': '11011', 'ฤ': '01011', 'ฤๅ': '01011',
      // vowels
      'ะ': '01000', 'า': '01', 'ิ': '00100', 'ี': '00', 'ึ': '00101', 'ื': '0011', 'ุ': '00101', 'ู': '1110', 
      'เ': '0', 'แ': '0101', 'ไ': '01001', 'ใ': '01001', 'โ': '111', 'ำ': '00010',
      // tone marks
      '่': '001', '้': '0001', '๊': '11000', '๋':'01010',
      // special marks
      'ั': '01101', '็': '11100', '์': '11001', 'ๆ': '10111', 'ฯ': '11010', 'ฯลฯ': '11101'
    }
  };
