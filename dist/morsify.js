...
(function (name, root, factory) {
  ...
  var swapCharacters = function swapCharacters(options) {
    var swapped = {};
    var mappedCharacters = getCharacters(options, true);
  ...
  var getOptions = function getOptions(options) {
    ...
    options = {
      ...
      oscillator: {
        type: options.oscillator.type || 'sine',
        // sine, square, sawtooth, triangle
        frequency: options.oscillator.frequency || 500,
        // value in hertz
  ...
  var audio = function audio(text, opts, morseString) {
    ...
    var silence = function silence(i) {
      gainNode.gain.setValueAtTime(0, t);
      t += i * options.unit;
    };
